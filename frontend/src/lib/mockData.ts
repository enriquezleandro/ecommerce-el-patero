...
export const mockProducts: Product[] = [
  // Indoor - Ventilación y Luces
  {
    id: '1',
    name: 'Panel LED Quantum Board 240W',
    category: 'indoor',
    price: 89990,
    description: 'Panel LED de alta eficiencia con espectro completo para todas las etapas del cultivo. Tecnología Samsung LM301B.',
    specifications: {
      'Potencia': '240W',
      'Cobertura': '90x90cm',
  ...
  // Fertilizantes
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1676083826533-1997f6a8dc28?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080'
    ],
    stock: 25,
    isFeatured: true,
    isNew: true,
  ...
  // Macetas y Sustratos
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1697813769280-0b46901aabb0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080'
    ],
    stock: 50,
    rating: 4.4
  },
  ...
  // Indumentaria
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1696086152504-4843b2106ab4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080'
    ],
    stock: 45,
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
